...
public class Canvas {
    public static void main(String[] args) {
        ...
        try {
            br = new BufferedReader(new FileReader("D:\\TheNewMoonST\\file\\link_request\\canvas.txt"));
    ...
    public  static void  SaveFile(String data) throws IOException {
        BufferedWriter writer = new BufferedWriter(new FileWriter("D:\\TheNewMoonST\\file\\link_request_action\\canvas.txt", true));
        writer.write(data + "\n");
        writer.close();
    }
}
