...
public class SaveDomainAndLinkProGram {
    public static void main(String[] args) {
        try {
            File myObj = new File("D:\\TheNewMoonST\\file\\domain_file\\dogsLink.txt");
            ...
            while (myReader.hasNextLine()) {
                ...
                while (check)
                {
                    ...
                    if (isJSONValid(outputResult)){
                        ...
                        if (obj.get("handle").toString().isEmpty() == true){
                            check = false ;
                        }else {
    ...
    public static void SaveFile(String data) throws IOException {
        BufferedWriter writer = new BufferedWriter(new FileWriter("D:\\TheNewMoonST\\file\\domain_file\\dogsHandle.txt", true));
        writer.write(data + "\n");
        writer.close();
    }
}
