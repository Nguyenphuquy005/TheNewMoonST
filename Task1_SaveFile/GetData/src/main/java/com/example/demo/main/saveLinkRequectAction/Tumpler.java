...
public class Tumpler {
    public static void main(String[] args) {
        BufferedReader br = null;
        try {
            br = new BufferedReader(new FileReader("D:\\TheNewMoonST\\file\\link_request\\tumpler.txt"));
    ...
    public  static void  SaveFile(String data) throws IOException {
        BufferedWriter writer = new BufferedWriter(new FileWriter("D:\\TheNewMoonST\\file\\link_request_action\\tumpler.txt", true));
        writer.write(data + "\n");
        writer.close();
    }
}
